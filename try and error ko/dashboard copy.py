...
class App(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        # ...
        self.detect_frame = customtkinter.CTkFrame(self, corner_radius=0)
        self.detect_frame.grid(row=0, column=1, sticky="nsew")
        self.image_label = customtkinter.CTkLabel(self.detect_frame)
...
##########################################################################
    def sidebar_button_event_detect(self):
        ...
        #import main
        #thread = threading.Thread(target=main.my_function)
        #thread.start()
        #main.my_function()
